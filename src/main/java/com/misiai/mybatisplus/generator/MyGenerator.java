package com.misiai.mybatisplus.generator;
...
public class MyGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/jdbc:mysql://localhost:3306/mp_test?useSSL=false");
        ...
        pc.setParent("com.misiai.mybatisplus");//你哪个父目录下创建包
